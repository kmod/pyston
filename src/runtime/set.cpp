...
void setupSet() {
    ...
    set_iterator_cls->giveAttr(
        "__iter__", new BoxedFunction(BoxedCode::create((void*)setiteratorIter, typeFromClass(set_iterator_cls), 1,
                                                        "setiterator.__iter__")));
    set_iterator_cls->giveAttr("__hasnext__", new BoxedFunction(BoxedCode::create((void*)setiteratorHasnext, BOXED_BOOL,
                                                                                  1, "setiterator.__hasnext__")));
    set_iterator_cls->giveAttr(
        "next", new BoxedFunction(BoxedCode::create((void*)setiteratorNext, UNKNOWN, 1, "setiterator.next")));
    set_iterator_cls->giveAttr(
        "__length_hint__",
        new BoxedFunction(BoxedCode::create((void*)setiteratorLength, BOXED_INT, 1, "setiterator.__length_hint__")));
    ...
    set_cls->giveAttr(
        "__new__",
        new BoxedFunction(BoxedCode::create((void*)setNew, UNKNOWN, 2, false, true, "set.__new__"), { NULL }));
    set_cls->giveAttr(
        "__init__",
        new BoxedFunction(BoxedCode::create((void*)setInit, UNKNOWN, 2, false, true, "set.__init__"), { NULL }));
    frozenset_cls->giveAttr(
        "__new__", new BoxedFunction(
                       BoxedCode::create((void*)frozensetNew, UNKNOWN, 2, false, true, "fozenset.__new__"), { NULL }));

    Box* set_repr_func = new BoxedFunction(BoxedCode::create((void*)setRepr, STR, 1, "set.__repr__"));
    ...
    auto add = [&](const char* name, void* func) {
        auto func_obj = new BoxedFunction(BoxedCode::create((void*)func, UNKNOWN, 2, false, false, name));
        set_cls->giveAttrBorrowed(name, func_obj);
        frozenset_cls->giveAttr(name, func_obj);
        /*
        BoxedCode* func_obj = BoxedCode::create(2, false, false);
    ...
    set_cls->giveAttr("__iter__", new BoxedFunction(BoxedCode::create((void*)setIter, typeFromClass(set_iterator_cls),
                                                                      1, "set.__iter__")));
    frozenset_cls->giveAttrBorrowed("__iter__", set_cls->getattr(getStaticString("__iter__")));

    set_cls->giveAttr("__len__", new BoxedFunction(BoxedCode::create((void*)setLen, BOXED_INT, 1, "set.__len__")));
    frozenset_cls->giveAttrBorrowed("__len__", set_cls->getattr(getStaticString("__len__")));

    set_cls->giveAttr("__contains__",
                      new BoxedFunction(BoxedCode::create((void*)setContains, BOXED_BOOL, 2, "set.__contains__")));
    ...
    set_cls->giveAttr("__nonzero__",
                      new BoxedFunction(BoxedCode::create((void*)setNonzero, BOXED_BOOL, 1, "set.__nonzero__")));
    frozenset_cls->giveAttrBorrowed("__nonzero__", set_cls->getattr(getStaticString("__nonzero__")));

    frozenset_cls->giveAttr("__hash__",
                            new BoxedFunction(BoxedCode::create((void*)setHash, BOXED_INT, 1, "set.__hash__")));
    set_cls->giveAttrBorrowed("__hash__", Py_None);

    set_cls->giveAttr("add", new BoxedFunction(BoxedCode::create((void*)setAdd, NONE, 2, "set.add")));
    set_cls->giveAttr("remove", new BoxedFunction(BoxedCode::create((void*)setRemove, NONE, 2, "set.remove")));
    set_cls->giveAttr("discard", new BoxedFunction(BoxedCode::create((void*)setDiscard, NONE, 2, "set.discard")));

    set_cls->giveAttr("clear", new BoxedFunction(BoxedCode::create((void*)setClear, NONE, 1, "set.clear")));
    set_cls->giveAttr("update",
                      new BoxedFunction(BoxedCode::create((void*)setUpdate, NONE, 1, true, false, "set.update")));
    set_cls->giveAttr("union",
                      new BoxedFunction(BoxedCode::create((void*)setUnion, UNKNOWN, 1, true, false, "set.union")));
    frozenset_cls->giveAttrBorrowed("union", set_cls->getattr(getStaticString("union")));
    set_cls->giveAttr("intersection", new BoxedFunction(BoxedCode::create((void*)setIntersection, UNKNOWN, 1, true,
                                                                          false, "set.intersection")));
    ...
    set_cls->giveAttr("intersection_update",
                      new BoxedFunction(BoxedCode::create((void*)setIntersectionUpdate, UNKNOWN, 1, true, false,
                                                          "set.intersection_update")));
    set_cls->giveAttr("difference", new BoxedFunction(BoxedCode::create((void*)setDifference, UNKNOWN, 1, true, false,
                                                                        "set.difference")));
    frozenset_cls->giveAttrBorrowed("difference", set_cls->getattr(getStaticString("difference")));
    set_cls->giveAttr("difference_update", new BoxedFunction(BoxedCode::create((void*)setDifferenceUpdate, UNKNOWN, 1,
                                                                               true, false, "set.difference_update")));
    set_cls->giveAttr("symmetric_difference",
                      new BoxedFunction(BoxedCode::create((void*)setSymmetricDifference, UNKNOWN, 2, false, false,
    ...
    set_cls->giveAttr("symmetric_difference_update",
                      new BoxedFunction(BoxedCode::create((void*)setSymmetricDifferenceUpdate, UNKNOWN, 2, false, false,
                                                          "set.symmetric_difference_update")));
    set_cls->giveAttr("issubset", new BoxedFunction(BoxedCode::create((void*)setIssubset, UNKNOWN, 2, "set.issubset")));
    frozenset_cls->giveAttrBorrowed("issubset", set_cls->getattr(getStaticString("issubset")));
    set_cls->giveAttr("issuperset",
                      new BoxedFunction(BoxedCode::create((void*)setIssuperset, UNKNOWN, 2, "set.issuperset")));
    frozenset_cls->giveAttrBorrowed("issuperset", set_cls->getattr(getStaticString("issuperset")));
    set_cls->giveAttr("isdisjoint",
                      new BoxedFunction(BoxedCode::create((void*)setIsdisjoint, UNKNOWN, 2, "set.isdisjoint")));
    frozenset_cls->giveAttrBorrowed("isdisjoint", set_cls->getattr(getStaticString("isdisjoint")));

    set_cls->giveAttr("copy", new BoxedFunction(BoxedCode::create((void*)setCopy, UNKNOWN, 1, "set.copy")));
    frozenset_cls->giveAttr("copy", new BoxedFunction(BoxedCode::create((void*)frozensetCopy, UNKNOWN, 1, "set.copy")));
    set_cls->giveAttr("pop", new BoxedFunction(BoxedCode::create((void*)setPop, UNKNOWN, 1, "set.pop")));
