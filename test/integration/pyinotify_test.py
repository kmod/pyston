...
print "\n>>>"
print ">>> Patching pyinotify..."
print ">>>"
PYINOTIFY_PATCH_FILE = os.path.abspath(os.path.join(os.path.dirname(__file__), "pyinotify_patch.patch"))
try:
    cmd = ["patch", "-p1", "--forward", "-i", PYINOTIFY_PATCH_FILE, "-d", PYINOTIFY_DIR]
...
print "\n>>>"
print ">>> Unpatching pyinotify..."
print ">>>"
cmd = ["patch", "-p1", "--forward", "-i", PYINOTIFY_PATCH_FILE, "-R", "-d", PYINOTIFY_DIR]
subprocess.check_output(cmd, stderr=subprocess.STDOUT)
